...
const DefaultNamespace = "brotherhood228"
...
func NewSummaryVec(name, help string, labelNames []string) *prometheus.SummaryVec {
...
// Panics if any error occurs.
func MustRegisterHistogramVec(name, help string, buckets []float64, labelNames []string) *prometheus.HistogramVec {
...
// Panics if any error occurs.
func MustRegisterSummaryVec(name, help string, labelNames []string) *prometheus.SummaryVec {
	c := NewSummaryVec(name, help, labelNames)
	MustRegister(c)
	return c
}
